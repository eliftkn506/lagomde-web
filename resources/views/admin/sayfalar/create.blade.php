...
@section('page_title', 'Yeni Sayfa Ekle')
...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-7">
    <div>
        <h1 class="text-xl font-bold text-gray-900">Yeni Sayfa Ekle</h1>
        <p class="text-sm text-gray-400 mt-0.5">Sitenizin alt kısmında (footer) görünecek bilgilendirme sayfalarını oluşturun.</p>
    </div>
...
{{-- FORM ALANI --}}
<form action="{{ route('admin.sayfalar.store') }}" method="POST">
    @csrf
            ...
            <div class="card p-6 md:p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="baslik" name="baslik" value="{{ old('baslik') }}" required
                           placeholder="Örn: Biz Kimiz?, İade Koşulları, KVKK Metni"
                    ...
                    <p class="text-[10px] text-gray-400 mt-2"><i class="fa-solid fa-info-circle mr-1"></i> Sayfa linki (slug) başlığa göre otomatik oluşturulacaktır.</p>
                </div>
                ...
                <div>
                    ...
                    <div class="border border-slate-200 rounded-xl overflow-hidden">
                        <textarea id="icerik" name="icerik">{{ old('icerik') }}</textarea>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        <select id="footer_konum" name="footer_konum" required
                            ...
                            <option value="kurumsal" {{ old('footer_konum') == 'kurumsal' ? 'selected' : '' }}>Kurumsal</option>
                            <option value="yardim" {{ old('footer_konum') == 'yardim' ? 'selected' : '' }}>Yardım</option>
                            <option value="sozlesmeler" {{ old('footer_konum') == 'sozlesmeler' ? 'selected' : '' }}>Sözleşmeler & Politikalar</option>
                        </select>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" id="sira" name="sira" value="{{ old('sira', 0) }}" min="0"
                ...
                <div class="flex items-center justify-between py-2 border-t border-gray-100 pt-5">
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 mt-0.5">Sitede yayınlansın mı?</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="aktif_mi" value="1" class="sr-only peer" {{ old('aktif_mi', true) ? 'checked' : '' }}>
            ...
            {{-- Kaydet Butonu --}}
            <button type="submit" class="w-full py-4 bg-slate-800 hover:bg-slate-900 text-white rounded-xl text-sm font-bold tracking-wide transition shadow-lg shadow-slate-200 flex items-center justify-center gap-2 group">
                <i class="fa-solid fa-check text-xs opacity-70 group-hover:scale-110 transition-transform"></i>
                SAYFAYI KAYDET
            </button>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ClassicEditor
            ...
            .then(editor => {
                // Tailwind stilleri ile uyumlu olması için editor boyunu ayarlayalım
